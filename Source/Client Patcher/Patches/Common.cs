namespace ClientPatcher.Patches
{
    class Common
    {
        public static byte[] Portal = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
        ...
        public static string VersionsFile = "trinity6.github.io/%s/%s/build/versi";
        public static char[] CertBundleUrl = { 'h', 't', 't', 'p', 's', ':', '/', '/', 't', 'r', 'i', 'n', 'i', 't', 'y', '6', '.', 'g', 'i', 't', 'h', 'u', 'b', '.', 'i', 'o', '/', 'B', 'n', 'e', 't', '/', 'z', 'x', 'x', 'x', 'x', 'x', 'x', 'x', 'x', '/', 'c', 'l', 'i', 'e', 'n', 't', '/', 'b', 'g', 's', '-', 'k', 'e', 'y', '-', 'f', 'i', 'n', 'g', 'e', 'r', 'p', 'r', 'i', 'n', 't' };
        public static string NewCertBundle = @"{
    ""Created"": 1455065214,
    ""Certificates"": [
    ...
    ""SigningCertificates"": [
  { ""RawData"": ""-----BEGIN CERTIFICATE----------END CERTIFICATE-----"" },
{ ""RawData"": ""-----BEGIN CERTIFICATE----------END CERTIFICATE-----"" },
{ ""RawData"": ""-----BEGIN CERTIFICATE----------END CERTIFICATE-----"" }
        ...
        public static string CertificatePrivateKey = "-----BEGIN RSA PRIVATE KEY-----" +
