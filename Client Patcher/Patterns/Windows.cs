...
namespace ClientPatcher.Patterns
{
    class Windows
    {
        ...
        {
            public static byte[] CertBundleCASCLocalFile = { 0x6A, 0x00, 0x8D, 0x45, 0xFC, 0x50, 0x8D, 0x45, 0xF8, 0x50, 0x68 };
            public static byte[] CertBundleSignatureCheck = { 0x59, 0x59, 0x84, 0xC0, 0x75, 0x08, 0x47, 0x83, 0xFF, 0x02 };
        }
